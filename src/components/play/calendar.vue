...
<!--Add Event Button-->
 <!--For Management, it redirects the user to Add new Event Page-->
      <button class="primary clear"  v-if= " roleSelect=='admin' || roleSelect=='manager'  || roleSelect=='secretary'  || roleSelect=='teacher' " v-link="'/play/event-add'">
      <i>add</i>
      </button>
<!--Add Event Button-->
...
<!--Kids Button-->
    ...
    <p>
    <quasar-inline-datetime :model.sync="model" type="date" class="full-width"></quasar-inline-datetime>
    </p>
<div  v-for="n in 4" class="card cursor-pointer" v-link="'/play/event'">
...
export default {
  data () {
    return {
      ...
      model: '2016-09-28T10:45:00.000Z'
}
}
